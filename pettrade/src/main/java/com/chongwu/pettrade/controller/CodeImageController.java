...
public class CodeImageController {
	...
	public String getCodeImage(HttpSession session, HttpServletResponse response) throws Exception{
		int width = 120;
        int height = 30;
        ...
        // 将生成的字母存入到session中   如果是web端开发,放在session里是没问题，
        //如果是手机端的开发，则你必须随图片，一起返回给客户端
